      ...
      <Card><CardContent className="p-0">
        <Table className="data-table">
          <TableHeader><TableRow>
            ...
            <TableHead>Семестр</TableHead><TableHead>Дисциплина</TableHead><TableHead>Тема</TableHead>
            <TableHead>Оценка</TableHead><TableHead>Дата</TableHead><TableHead>Преподаватель</TableHead>
          ...
          <TableBody>
            {items.length === 0 ? (
              ...
              <TableRow key={c.id}>
                ...
                <TableCell><Badge variant={gradeIsPassing(c.grade) ? "success" : "destructive"}>{c.grade}</Badge></TableCell>
                  ...
                  <TableCell className="text-right">
                    <CourseWorkRowActions
                      ...
                      initial={{
                        ...
                        topic: c.topic, grade: c.grade, date: c.date.toISOString().slice(0, 10), teacherId: c.teacherId,
                      }}
                      students={oS} semesters={oSem} disciplines={oD} teachers={oT}
                      canEdit={can(session, "courseWork:edit")} canDelete={can(session, "courseWork:delete")}
                    />
                  </TableCell>
                )}
              </TableRow>
