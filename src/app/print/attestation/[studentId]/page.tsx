...
export default async function PrintAttestation({ params }: { params: Promise<{ studentId: string }> }) {
  ...
  const tmpl = await prisma.documentTemplate.findUnique({ where: { code: "ATTESTATION_REPORT" } });
